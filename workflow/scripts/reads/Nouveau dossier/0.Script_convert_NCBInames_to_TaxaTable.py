...
if os.path.exists(EXIT_FILE):
    os.remove(EXIT_FILE)
    print(f"Ancien fichier {EXIT_FILE} supprimé.")
        ...
        with z.open(NAME_FILE_IN_ZIP) as f_in, open(exit, 'w', encoding='utf-8') as f_out:
            ...
            for binary_line in f_in:
                ...
                if len(parts) >= 9:
                    ...
                    # Si une colonne est vide, on lui donne le sci_name et après on ajoute "_u" aux suivantes
                    ...
                    final_line = [tax_id, sci_name] + ranks
