...
def run_full_qc(snakemake, steps_config):
    ...
    for path in DATA:
        ...
        for item in ["count-contigs-coassembly-", "Raw_counting_", "Filtered_Contigs_", 
                     "RPKM_Contigs_", "Trimmed_", "Final_Selected_", "annotated_", "union_",
                     "rpkm_filtered_", "rpkm_", "counted_", "filtered_", "contigs_",
                     ".tsv", ".csv", ".txt", ".kaijuNR"]:
